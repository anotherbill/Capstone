            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h4><span>${user.userName}: $user.name</span> </h4>
                            ...
                            <a href="editUser" class="btn btn-primary" role="button">Edit</a>  <a href="deleteAsset" class="btn btn-danger" role="button" data-toggle="modal">Delete</a><br/><br/>
